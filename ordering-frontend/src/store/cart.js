...
// 책임과 권한을 분리하는 개념적인 의도도 있지만, 다른 스토어나 상황에서 재사용성을 높이기 위한 아키텍처
function initState() {
    return{
        // 초기 데이터(장바구니에 담긴 아이템, 수량)
        // json -> 객체
        // 장바구니에서 꺼내오기
...
export default createStore({
    ...
    // 일반적으로 component에서 actions 메서드를 호출하고, actions에서 mutation메서드 호출
    actions: {
        // context매개변수가 주입 - context매개변수 안에 state, commit 등이 존재
